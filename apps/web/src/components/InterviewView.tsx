...
export function InterviewView({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-300">
      {/* Editorial Header & Discreet Progress */}
      <div className="space-y-3">
        ...
        {/* Refined and Discreet Polish Mode Banner */}
        {isElitePolish && (
        ...
        {roundNumber >= 2 && !isElitePolish && (
          <div className="p-3 rounded-xl bg-[#0F1623]/80 border border-[#1E293B] text-xs text-slate-300 leading-relaxed flex items-start gap-2">
      ...
      {/* Main Question Dossier Card */}
      <div className="rounded-2xl border border-[#1E293B] bg-[#0F1623]/80 p-6 sm:p-7 space-y-5 shadow-sm">
        ...
        {/* Comfortable Editorial Question Typography */}
        <h2 className="text-xl sm:text-[22px] font-semibold text-white leading-relaxed tracking-tight">
          {currentQ.question}
        </h2>

        {/* US Recruiter Context Note (Single Fluid Editorial Callout, No Duplicate Nested Boxes) */}
        <div className="p-4 rounded-xl bg-[#090D14]/70 border-l-2 border-l-blue-500 border-y border-r border-[#1E293B] space-y-1">
        ...
        <div className="space-y-2.5 pt-1">
          ...
          {currentQ.answerType === 'single-choice' && currentQ.options ? (
            ...
            <Textarea
              ...
              className="text-sm leading-relaxed bg-[#090D14]/80 border-[#1E293B] focus:border-blue-500 rounded-xl"
            />
          )}
        ...
        {/* Well-Spaced Bottom Actions (Zero Arrows) */}
      ...
      {roundNumber >= 2 && onSkipToFacts && (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 p-4 rounded-xl bg-[#0F1623]/80 border border-[#1E293B] text-xs text-slate-400">
          ...
          <Button
            ...
            onClick={onSkipToFacts}
            disabled={isLoading}
            className="text-xs border-[#1E293B] text-slate-300 hover:text-white bg-[#090D14]"
          >
