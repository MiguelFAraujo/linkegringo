          ...
          <div className="grid grid-cols-1 gap-3">
            {criteriaBreakdown.map((c) => {
              ...
              return (
                <div
                  key={c.id}
                  className="p-4 rounded-xl border border-[#1E293B] bg-[#090D14]/60 space-y-3"
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="flex items-start gap-3 min-w-0">
                      <div className="p-2 rounded-lg bg-blue-500/10 text-blue-400 mt-0.5 sm:mt-0 flex-shrink-0 border border-blue-500/20">
                    ...
                    <div className="flex items-center gap-3 self-end sm:self-center flex-shrink-0 pt-1 sm:pt-0">
                      ...
                      <Badge
                        ...
                        className={`text-xs font-semibold py-0.5 px-2 font-mono ${
                          delta > 0
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-xs">
                    <div className="space-y-1">
                      ...
                      <Progress
                        ...
                        className="h-2 bg-[#090D14] border border-[#1E293B]"
                      />
                    </div>
      ...
      <div className="space-y-4">
        ...
        <Tabs defaultValue="headline">
          ...
          <TabsContent value="headline" className="space-y-4">
            <Card className="p-6 border-[#1E293B] bg-[#0F1623]/80 space-y-4 shadow-lg">
              <div className="flex items-center justify-between">
                <div>
              ...
              {analysis.rewritten.experiences.map((exp, idx) => {
                ...
                return (
                  <Card key={idx} className="p-5 border-[#1E293B] bg-[#0F1623]/80 space-y-4 shadow-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs pt-1 border-t border-[#1E293B]">
